...
<head>
    ...
    <title>Eliminar Productos de la Sucursal</title>
...
<body>
    <div class="container my-5">
        ...
        <div class="row">
            <div class="col text-center">
                <h1 class="h3 text-primary">Eliminar Productos de la Sucursal</h1>
                <hr class="my-4">
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card shadow">
                    <div class="card-body">
                        <form action="{{ route('bodega.eliminar.productos') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                <label for="cantidad" class="font-weight-bold">Cantidad a Eliminar</label>
